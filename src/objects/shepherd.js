...
const ShepherdFactory = () => {
  ...
  let leftLeg = Our3DObject(OurMesh(Cylinder(0.2, 1.5, 8, 6), false), [1, 1, 0.1])
  leftLeg.transform(MatrixLibrary.rotationMatrix(Math.PI / 2, 0, 0))
  leftLeg.transform(MatrixLibrary.translationMatrix(0.75, -1, 1))

  let rightLeg = Our3DObject(OurMesh(Cylinder(0.2, 1.5, 8, 6), false), [1, 1, 0.1])
  ...
  let arm = Our3DObject(OurMesh(Cylinder(0.2, 1.5, 8, 6), false), [1, 1, 0.1])
  ...
  let staffBase = Our3DObject(OurMesh(Cylinder(0.1, 3.5, 8, 6), false), [1.21, 0.63, 0.13], 'staffBase')
  ...
  let hook1 = Our3DObject(OurMesh(Cylinder(0.1, 1, 8, 6), false), [1.21, 0.63, 0.13])
  ...
  let hook2 = Our3DObject(OurMesh(Cylinder(0.1, 0.5, 8, 6), false), [1.21, 0.63, 0.13])
